...
Geoflow was used to model the 3D envelope of a building based on a pointcloud, which was subsequently scaled up in the creation of the 3D BAG dataset (source).
...
The reason Kuhail et al. give for this stark difference is in one line with research covered in \refsec{sec:background-web}: 
