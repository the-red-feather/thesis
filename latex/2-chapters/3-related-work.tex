...
By far the most well-known visual programming language within the field of \ac{GIS} is the commercial \ac{ETL} tool FME \citep{safe-software_fme_2022}, (see \reffig{fig:gisvpl:1}). 
...
Applications like Blender's geometry nodes \citep{blender_foundation__contributers_geometry_2022}, Rhino's Grasshopper \citep{rutten_grasshopper_2012}, or Houdini \citep{sidefx_houdini_2022}, are all widely used to automate the creation of geometry. 
...
This application is called the Möbius modeller \citep{janssen_mobius_2021}, and is by far the closest equivalent to the geo-web-vpl proposed by this study.
