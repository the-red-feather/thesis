...
On a conceptual level, and based on the achieved functionality, a web-based VPL is a feasible method for providing direct access to native \ac{GIS} libraries.
