...
The WebAssembly standard may solve many existing problems, and leads to multiple new use cases (SOURCE: https://blog.scottlogic.com/2022/06/20/state-of-wasm-2022.html).

Based on the contemporary usage of WebAssembly, it is safe to conclude that it leads to a significant paradigm shift 
