...
diagram-based \citep{blender_foundation__contributers_geometry_2022}, 
...
\begin{figure}[!tbp]
  ...
  \begin{minipage}[b]{0.80\textwidth}
    ...
    \caption{End User development by means of GUI algebra}
    % based on the finding of \cite{jangda_not_2019}
...
This literary study was able to confirm this. 
Not one of the open source VPLs mentioned by this chapter or the upcoming \refsec{sec:related-geovpl} or \refsec{sec:related-webvpl}, contains aspects like Git version control, or integration / delivery pipelines.
For paid \ac{VPL}s, deployment and version control is sometimes possible for a fee. 
However, users can only use the publication tools, version control tools, and package / library managers offered to them by the vendors.
