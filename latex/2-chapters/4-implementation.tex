...
This takes some additional inspiration from the cartography of metro networks, as well as the design of computer chips. This makes for a good fit, since both these spatial configurations and the Geofront Graph desire connectivity to be clear above all else.
