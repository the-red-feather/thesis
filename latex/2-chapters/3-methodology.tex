...
The methodology can be characterized as practical as opposed to theoretical, wholistic instead of specific, and iterative compared to linear.
 
The methodology of this study is subdivided into three sub-studies, based on the first three sub-research questions: \refsec{sec:method-one}, \refsec{sec:method-two}, and \refsec{sec:method-three}.  
These three studies are conducted to find answers to the major 'hows' of the geo-web-vpl. 
Prior studies were unable to provide answers with sufficient coverage, but did provide a strong starting point. 

While this may give the impression that these are separate, isolated issues, the design of one of these studies was often presented by side-products from the two other components. 
