...
The advantage of this approach is that it leads to tangible results, which can then be reasoned about.   
...
Part of this study is gathering a clear picture of the capabilities present in the browser itself. 
As such, it helps to make the results of this study detached from specific frameworks.
