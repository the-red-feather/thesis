...
The study takes place at the intersection of three fields

of the two fields of Visual programming and web GIS applications. 
This chapter is divided into three sections. \refsec{sec:vp} and \refsec{sec:webgis} each cover one of these fields individually, and \refsec{sec:both} covers comparable studies at this intersection.
...
The study is conducted by implementing a prototype \ac{geo-web-vpl}. This can in turn be used to visit each one of these sub-question, 

\section{GEO: Geocomputation}

\subsection{Geocomputation libraries}

\section{WEB: Client-side web applications}

\subsection{WebAssembly}

\subsection{Web GIS}

\section{VPL: Visual Programmming}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Visual Programming: VPL}
\label{sec:vp}
