...
\begin{enumerate}[-]
  \item \refsec{sec:background-geo} GEO: Geocomputation (TODO write this, small part)
  \item \refsec{sec:background-web} WEB: (Progressive) Web applications (TODO edit and write this)
  \item \refsec{sec:background-vpl} VPL: Visual Programming Languages (TODO write this)
\end{enumerate}
These will be covered in \refsec{sec:background}.
...
\begin{enumerate}[-]
  \item \refsec{sec:related-geoweb} (practically finished)
  \item \refsec{sec:related-geovpl} (needs work)
  \item \refsec{sec:related-webvpl} (can be very brief)
\end{enumerate}
These studies will be reviewed in \refsec{sec:related}.
...
%   __) | | |                                                                 %
%  / __/ _| |                                                                 %
% |_____(_|_| Background                                                      %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\subsection{Geocomputation}
...
%   __) | | | | |                                                             %
%  / __/ _| |_| |                                                             %
% |_____(_|_(_|_| Background: GEO                                             %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


\subsubsection{Geocomputation libraries}
\label{sec:background-geolib}
...
%   __) | | |   __) |                                                         %
%  / __/ _| |_ / __/                                                          %
% |_____(_|_(_|_____| Background: WEB                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subsection{Visual Programmming}
...
%   __) |   __) | | |                                                         %
%  / __/ _ / __/ _| |                                                         %
% |_____(_|_____(_|_| Related Works: GEOWEB                                   %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subsection{Visual programming and geocomputation}
...
\subsection{Browser-based visual programming}
...
%   __) |   __) |   |_ \                                                      %
%  / __/ _ / __/ _ ___) |                                                     %
% |_____(_|_____(_|____/ Related Works: WEBVPL                                %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
