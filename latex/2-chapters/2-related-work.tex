...
This chapter offers an overview of the theoretical background that this study builds upon, alongside a review of comparable studies.
The study takes place at the intersection of three fields, represented by the corners of \reffig{fig:triangle-model}:
\begin{enumerate}[-]
  \item \refsec{sec:background-geo} covers the background on geocomputation (GEO) 
  \item \refsec{sec:background-web} covers the background on (Progressive) Web applications (WEB)
  \item \refsec{sec:background-vpl} covers the background on Visual Programming Languages (VPL) 
\end{enumerate}
...
\begin{enumerate}[-]
  \item \refsec{sec:related-geoweb} reviews related works on browser-based geoprocessing (GEO + WEB)
  \item \refsec{sec:related-geovpl} reviews related works on VPLs used for geo-computation (GEO + VPL)
  \item \refsec{sec:related-webvpl} reviews related works on VPL web applications (WEB + VPL)
\end{enumerate}

\section{Geocomputation (GEO)}
...
\emph{What are the most common types geocomputation?}
...
D. SIGNIFICANT LIBRARIES

- CGAL, GDAL, despite name similarities, very different libraries. 

GDAL is really meant for geographical data: Geospatial Data Abstraction Library
...
\section{(Progressive) Web applications (WEB)}
...
\subsection*{Noteworthy examples of }

(Overleaf)

\subsubsection{Web GIS}
...
%   __) | | |   |_ \                                                          %
%  / __/ _| |_ ___) |                                                         %
% |_____(_|_(_|____/ Background: VPL                                          %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
This study is related to a series of studies concerned with browser-based geocomputation, also referred to as client-side geocomputation. 
As such, it is important to relate to previous attempts and efforts, to learn from their findings, and to make sure the exact same research will not be performed twice. 
...
%  __) |   __) |   __) |                                                      %
% / __/ _ / __/ _ / __/                                                       %
% |_____(_|_____(_|_____| Related Works: GEOVPL                               %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
acknoledgements
...
(rasterfoundry, but doesnt really count)

\subsection{Geocomputation Web Vpls (GEO + WEB + VPL)} 
