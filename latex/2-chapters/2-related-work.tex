...
\begin{enumerate}[-]
  \item \refsec{sec:background-geo}
  \item \refsec{sec:background-web}
  \item \refsec{sec:background-vpl}
\end{enumerate}
...
\begin{enumerate}[-]
  \item \refsec{sec:related-geoweb}
  \item \refsec{sec:related-geovpl}
  \item \refsec{sec:related-webvpl}
\end{enumerate}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{OLD: Visual Programming: VPL}
\label{sec:vp}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{ In Geometry Computation \& Visualization: GEO-VPL }
\begin{lstlisting} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection*{OLD Browser-based geoprocessing}
\label{sec:bbg}
