...
Special care has been put into the style of the implementation.
The visuals take inspiration from various geometry VPLS, such as Blender's GeometryNodes, McNeel's Grasshopper, and Ravi Peter's GeoFlow (SOURCE). 
...
Several demo plugins were created during the development of this implementation, which are covered by \refsec{sec:analyses:compilation}.
