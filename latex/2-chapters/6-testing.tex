...
% WHY? (move this over to methodology)
We wish to assess how well the plugin system handles different libraries, and different languages. 

\subsection{Writing a Geofront plugin in Rust}
...
(show startin, also in usage)



\subsection{Writing a Geofront plugin in C++}
...
In this chapter: Judge, but do not conclude.
...
\begin{note}
  ...
  TODO: make a table showing differences
  ...
  C++ WebAssembly also tend to be larger
