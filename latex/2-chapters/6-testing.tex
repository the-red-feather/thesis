...
Secondly, to compile this file to the right binary with accompanied javascript wrapper, it had to be compiled using the \m{-sMODULARIZE=1} and \m{-sEXPORT_ES6=1} flags enabled.
...
Finally, while javascript file was albe to be loaded 

This is fully due to the implementation choices of the Geofront plugin loader. 
to load a plugin at runtime, the source files are fetched and interpreted at runtime. 
This makes it so files within 

% All in all, too many obstacles were in the way of successfully loading C++ within Geofront within the time frame of this study. 

\begin{figure}
  \graphicspath{{../../assets/images/6.1.3}}
  \centering
  \includegraphics[width=0.50\linewidth]{demo.PNG}
  \caption[loading a plugin]{web demo}
...
\begin{figure}
  ...
  \caption[loading a plugin]{Some of the 134 functions the emscripten compiler includes in its javascript wrapper, which had to be filtered out.}
