...
\begin{itemize}[ ]
  ...
  \item \refchap{chap:implementation-results-analyses}, Implementation, presents the implementation of the methodology, additionally, it describes the results obtained after the implementation of the methodology. 
