...
One possible interface of such an application is a Visual Programming Language (vpl), or visual programming environment. 
- Explain what it is. 
...
% RANSAC
% Jonathan blow -> didactic games  
% Game Of Life -> impossibility of 'proving' behaviour systems. 


% in a browser-based front-end using WebAssembly.
...
% FROM MEETING 27:
% \item To what extend does this solution contribute to making geoprocessing more Findable, Accessible, Interoperable, and Reusable?
