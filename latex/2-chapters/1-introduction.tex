...
The overarching goal of this study is to allow end-users more \textbf{direct} access to core transformation and analysis capabilities found in native \ac{GIS} libraries, in a format which allows \textbf{composability} (\reffig{fig:goal})).
...
In addition, a combination of WebAssembly and a static web application could allow for direct accessibility and execution of native \ac{GIS} libraries in a web browser, using statically hosted geodata as its data source. 
