...
\begin{note}
  - Add balancing act between application and server 
  - Add serverless aspect: "as a side effect, enabled their application to be published on the web without an active server. "
\end{note}
...
Questions which needs answering in the introduction: 

- Why does the field of GIS need (another) VPL?
  ...
  - One possible application of a VPL in GIS is using them for web-based, serverless geocomputation. 
  - 


- What makes it necesairy to develop a VPL specific for GIS? Can't existing VPL's be used?
- In other words: What is a GIS VPL in relationship to general VPLs:
    ...
    - Other applied GIS fields do not have the same 
	- This means that any VPL which claims to be 'aimed at GIS', will need to at least provide an answer on how it can be scaled.	

  
  - However, A stark difference compared to the larger field of applied CG. can be found in the need of scalability in GIS 
...
- Explain ideal GIS VPL
- Then explain how current GIS VPLs come short of this
- Then explain what this thesis will focus on
