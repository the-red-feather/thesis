...
\textit{" In which ways and to what extent does a web-based geo-vpl contribute uniquely to the activity of geo-computation? "} % on other words, what is the use-case of a geo-web-vpl?
