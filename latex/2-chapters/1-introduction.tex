...
By doing so, this thesis seeks to assess to what end geo-computation can profit from the advantages of VPL-based geoprocessing (interactivity) in combination with advantages of web-based applications (distribution and accessibility).

The method differentiates itself by allowing client-side, browser-based calculations. 
To the best of the authors knowledge, no prior research on the exact topic of a web-based VPL for geo-computation exists.
...
\textit{"How does a web-based geo-vpl contribute to the activity of geo-computation? "} % on other words, what is the use-case of a geo-web-vpl?
