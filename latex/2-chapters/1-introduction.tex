...
\begin{itemize}[ ]
  ...
  \item \refchap{chap:analyses} analyses this implementation. 
  % \item \refchap{chap:analyses} analyses this implementation. additionally, it describes the results obtained after the implementation of the methodology. 
