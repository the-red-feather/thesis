...
\begin{enumerate}[a]
  ...
  \todo{I have some literature lined up to specify the usability of a vpl into contrete features } 
...
...
\begin{itemize}[\m{->}]
  \item chapter 2: More background \& reasoning behind web VPL and web GIS. 
  \subitem Developments and challenges within these fields.
  \item chapter 3: Specify 'the solution', Convert the literature of chapter 2 directly into requirements for the solution. 
