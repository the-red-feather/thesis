...
The final step is to set up and execute a series of tests (\refsec{sec:method:tests}), to analyze the extend to which these implementations solve the various challenges raised by \refchap{chap:intro}.
...
For C++, the Emscripten compiler can be used to compile to WebAssembly \citep{}. 
...
Startin was chosen, for the triangulation functionalities it provides are comparable to that of CGAL, in terms of performance, and geometric robustness. 
