...
But first, I wish to clarify the overall methodology

\section{Overall}

\subsection*{Nature}
The methodology of this study can be characterized as practical as opposed to theoretical, 
wholistic instead of specific, and iterative compared to linear. 
...
This was necessary because of the observation that successful vpls involved with computational geometry are all dataflow-vpls (see \refsec{sec:related-geovpl}), but no existing web-vpl concerned with geometry uses this model (\refsec{sec:related-webvpl}).
...
Question C and D are answered by \refsec{sec:analyses:representation}.
...
\begin{figure}
  \centering
  \graphicspath{ {../../assets/images/methodology/} }
  \includegraphics[width=\linewidth]{loading-trajectory.jpg}
...
There is also a second reason for critically accessing the library / plugin loader.
