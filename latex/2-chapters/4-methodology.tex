...
Due to the many advantages posed in \refsec{sec:background:dataflow}, but especially the concurrency advantages, a dataflow-type VPL had to be chosen for the topic of geocomputation.
