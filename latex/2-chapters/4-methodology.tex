...
% To explain it, we must elude to a proposed backend runtime of the VPL. 
% This is not part of this study, but would be a valuable follow-up research.

This expanded proposal is shown in \reffig{fig:proposal-extended}.
...
The second demo expands upon this first demo, and is intended to examine to what extend such a library can actually be composed as part of a 'real' application. 
