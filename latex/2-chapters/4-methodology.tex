...
This chapter present the design of the proposed method, and announces the assessment tests.
...
The overall methodology is to first develop the VPL and surrounding framework application (\refsec{sec:method:base-vpl}), followed up by developing a binding system for this VPL (\refsec{sec:method:plugin-system}). 
