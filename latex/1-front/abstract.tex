...
The study poses that this problem can only be overcome if native geocomputation libraries are able to be properly \emph{compiled}, \emph{loaded}, and \emph{utilized} in a browser-based dataflow-VPL format.
