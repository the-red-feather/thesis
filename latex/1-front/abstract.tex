...
Additionally, the tools end-users are left with are often not composable to the same degree as the software they originated from. 
...
The goal of this study is to make core \ac{GIS} libraries more directly available to end-users.
