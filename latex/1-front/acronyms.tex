...
\begin{acronym}
    ...
    \acro{bbg}{Browser-based geocomputation}
    \acro{vpl}{Visual Programming Language}
    \acro{geo-vpl}{vpl for geocomputation}
    \acro{geo-web-vpl}{Browser-based visual programming environment for geocomputation}
