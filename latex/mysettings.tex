...
\newcommand{\mySubRQOne}{\textit{To what extend is the browser capable of \textbf{representing} a generic dataflow-vpl for processing 3D geometry?}}
...
\newcommand{\mySubRQTwo}{\textit{To what extend can geocomputation libraries written in system-level languages be \textbf{compiled} for web consumption?}}
\newcommand{\mySubRQThreeTitle}{Loading}
\newcommand{\mySubRQThree}{\textit{To what extend can a web-consumable library be \textbf{loaded} into a web-vpl without explicit configuration?}}
...
\newcommand{\mySubRQFour}{\textit{To what extend can a 'geo-web-vpl' be \textbf{used} to create geodata pipelines?}}
