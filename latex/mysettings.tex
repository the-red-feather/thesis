...
\newcommand{\mySubRQTwo}{\textit{\mySubRQTwoTitle: How to implement a visual programming environment in a browser which able to facilitate geo-computation?}}
\newcommand{\mySubRQThreeTitle}{Distribution}
\newcommand{\mySubRQThree}{\textit{\mySubRQThreeTitle: How can a web-consumable library be loaded into a web-vpl?}}
