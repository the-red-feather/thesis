...
\newcommand{\mySubRQOne}{\textit{\mySubRQOneTitle: To what extend can existing geoprocessing libraries be made available for direct web consumption?}}
\newcommand{\mySubRQTwoTitle}{Interface}
\newcommand{\mySubRQTwo}{\textit{\mySubRQTwoTitle: How to implement a visual programming environment on the web focussed on geometry processing?}}
\newcommand{\mySubRQThreeTitle}{Distribution}
\newcommand{\mySubRQThree}{\textit{\mySubRQThreeTitle: How can web-consumable libraries be dynamically loaded and used within a web-vpl?}}
