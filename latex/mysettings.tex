...
\newcommand{\myGraduationMonth}{November}
...
\newcommand{\myNewSubRQOne}{\textit{What GUI features are required to facilitate this method, and to what extent does the web platform aid or hurt these features?}}
\newcommand{\myNewSubRQTwo}{\textit{To what extent does this method intent to address the discrepancies between software applications and libraries, as described by Elliott (2007)? Does it succeed in doing so?}}
