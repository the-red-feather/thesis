...
\newcommand{\myMainRQ}{\textit{How can a VPL be used to support and execute existing geo-computation libraries in a browser?}}
...
\newcommand{\mySubRQOne}{\textit{To what extend is the browser capable of redering  generic 3D geometry and a vpl graph?}}
