...
\newcommand{\mySubRQOne}{\textit{To what extend is a browser-based application able to facilitate a vpl for geocomputation?}}
...
\newcommand{\mySubRQTwo}{\textit{To what extend can existing geo-computation libraries be compiled for web consumption?}}
...
\newcommand{\mySubRQFour}{\textit{What are the advantages and disadvantages of using an existing geoprocessing library through a geo-web-vpl, as opposed to native utilization of said libraries?}}
