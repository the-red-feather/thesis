...
\newcommand{\myMainRQ}{\textit{How to design and implement a web-based vpl for geo-computation which can directly utilize existing geoprocessing libraries?}}
...
\newcommand{\mySubRQTwo}{\textit{\mySubRQTwoTitle: How to implement a visual programming environment in a browser, and which able to facilitate geometry processing?}}
\newcommand{\mySubRQThreeTitle}{Distribution}
\newcommand{\mySubRQThree}{\textit{\mySubRQThreeTitle: How can a web-consumable library be loaded and used within a web-vpl?}}
\newcommand{\mySubRQFourTitle}{Utilization}
\newcommand{\mySubRQFour}{\textit{\mySubRQFourTitle: What are the advantages and disadvantages of using an existing geoprocessing library through a geo-web-vpl, as opposed to native utilization of said libraries?}}
