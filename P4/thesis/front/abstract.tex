...
The goal of this research to improve the accessibility of geodata processing and analysis libraries, without adding major changes to those tools, and by utilizing the capabilities of the modern web. This goal is captured by the research question: How well do modern web technologies improve the accessibility of existing geoprocessing libraries?

The answer is in two fold. First
