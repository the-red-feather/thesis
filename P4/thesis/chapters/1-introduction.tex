...
\subsection*{Obstacle 1: \ac{csg} is technically challenging}
...
% SOLUTION: Make it
\subsection*{Obstacle 2: \ac{csg} is immature}
...
\subsection*{Obstacle 3: \ac{csg} can be considered unnecessary}
