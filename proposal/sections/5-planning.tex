...
\afterpage{
  ...
  \definecolor{progressgreen}{RGB}{0, 140, 0}
  ...
  \begin{ganttchart}[
    ...
    \ganttnewline 
    \ganttbar[progress=10]{Thesis Paper}{10}{25}\\
    \ganttmilestone[]{P3 Assessment}{12} \ganttnewline
    \ganttmilestone[]{P4 Assessment}{20} \ganttnewline
    \ganttmilestone[]{P5 Assessment}{25}

  \end{ganttchart}

  \caption{Gantt chart of the methodology, made with pgfgantt}
  \label{fig:gantt}
  \end{figure}
  \end{landscape}
}