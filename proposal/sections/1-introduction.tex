...
The study proposed by this paper seeks the advancement of web \ac{gis} \& client-side geoprocessing by attempting to overcome these three obstacles. It will do this by researching possible solutions to key components of all three obstacles. However, we must first regard the obstacles more closely, in order to explain the choices of these key components. 
...
These uncertainties remain, as of today, unanswered.
...
From these three obstacles, we can summarize the following problem: 
...
% what 
The use case application for this study is the so called "GeoFront" environment, nicknamed as a concatenation of 'geoprocessing' and 'frontend'. 
